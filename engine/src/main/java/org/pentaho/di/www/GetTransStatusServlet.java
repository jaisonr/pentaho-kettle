    ...
    if ( trans != null ) {
      if ( useXML ) {
        ...
        try {
          ...
          out.print( "<td style=\"padding: 8px 10px 10px 10px\" class=\"cellTableCell cellTableLastColumn\">" + ((dateStr != null && dateStr.substring( 0, dateStr.indexOf( ' ' ) ) != null) ? dateStr.substring( 0, dateStr.indexOf( ' ' ) ): "-") + "</td>" );
          out.print( "</tr>" );
          out.print( "</table>" );
          out.print( "</div>" );
